...
struct matrix * make_rotX(double theta) {
  ...
  matrix->m[1][1] = cos(M_PI * theta / 180);
  matrix->m[1][2] = -1 * sin(M_PI * theta / 180);
  matrix->m[2][1] = sin(M_PI * theta / 180);
  matrix->m[2][2] = cos(M_PI * theta / 180);
...
struct matrix * make_rotY(double theta) {
  ...
  matrix->m[0][0] = cos(M_PI * theta / 180);
  matrix->m[0][2] = sin(M_PI * theta / 180);
  matrix->m[2][0] = -1 * sin(M_PI * theta / 180);
  matrix->m[2][2] = cos(M_PI * theta / 180);
...
struct matrix * make_rotZ(double theta) {
  ...
  matrix->m[0][0] = cos(M_PI * theta / 180);
  matrix->m[0][1] = -1 * sin(M_PI * theta / 180);
  matrix->m[1][0] = sin(M_PI * theta / 180);
  matrix->m[1][1] = cos(M_PI * theta / 180);
